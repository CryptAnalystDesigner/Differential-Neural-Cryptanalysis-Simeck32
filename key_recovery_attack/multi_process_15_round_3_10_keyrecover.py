...
# 读取模型网络参数
pairs = 8
# net10 = load_model("simeck32_best_model_10r_depth5_num_epochs20_pairs8_acc_0.7374.h5")
# net9 = load_model("simeck32_best_model_9r_depth5_num_epochs20_pairs8_acc_0.9954144954681396.h5")
...
m9 = np.load("simeck32_data_wrong_key_mean_9r_pairs8_acc_0.9952914714813232.npy");
s9 = np.load("simeck32_data_wrong_key_std_9r_pairs8_acc_0.9952914714813232.npy"); 
...
def test(device,n=20,nr=15, num_structures=2**10, it=2**11, cutoff1=10, cutoff2=10):
    #         轮数  结构数                迭代轮数    c1界          c2界                             
    ...
    net9 = load_model("simeck32_best_model_9r_depth5_num_epochs20_pairs8_acc_0.9952914714813232.h5")
    net = net10;net_help = net9
    m_main=m10;s_main=s10;  
    m_help=m9;s_help=s9
    # neutral_bits = [[7],[8],[9],[13],[14],[15],[18],[20],[22],[24],[30],[0,31],[10,25]]
    neutral_bits = [[7],[8],[9],[13],[14],[15],[18],[20]]
    ...
    for i in range(n):
        ...
        # 生成多明文对
        pt0,pt1,p0b,p1b = make_structure(pt0,pt1,diff=(0x0140, 0x0200),neutral_bits=[[3],[4],[5]])
