...
m12 = np.load("simeck32_data_wrong_key_mean_12r_pairs8_acc_0.5160934925079346.npy");
s12 = np.load("simeck32_data_wrong_key_std_12r_pairs8_acc_0.5160934925079346.npy"); 
...
def test(device,n=15,nr=17, num_structures=2**10, it=2**11, cutoff1=20, cutoff2=-120):
    #         轮数  结构数                迭代轮数    c1界          c2界                             
    ...
    net12 = load_model("staged_simeck32_best_model_12r_depth5_num_epochs20_pairs8_acc_0.5160934925079346.h5")
    net11 = load_model("staged_simeck32_best_model_11r_depth5_num_epochs20_pairs8_acc_0.5663520097732544.h5")
    net = net12;net_help = net11
    m_main=m12;s_main=s11;  
    m_help=m12;s_help=s11
    # neutral_bits = [[7],[8],[9],[13],[14],[15],[18],[20],[22],[24],[30],[0,31],[10,25]]
    neutral_bits = [[7],[8],[9],[13],[14],[15],[18],[20],[22],[24],[30],[0,31]]
